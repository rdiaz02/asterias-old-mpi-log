...
if test_type in limma_tests:
    R_launch ="/usr/bin/R CMD BATCH --no-restore --no-readline --no-save -q limma_functions.R"
    ...
    fullPomelocommand = 'cd ' + tmpDir + '; ' + '/http/mpi.log/tryRrun2.py ' + tmpDir +' 10 ' + 'PomeloII_cox'
